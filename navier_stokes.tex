...
In den \PimiddyBegriff{Navier-Stokes-Gleichungen}, benannt nach den
Mathematikern \PimiddyName{Claude-Louis Navier} und
\PimiddyName{George Gabriel Stokes}, die in
...
\PimiddyQuotes{ausgleichend}. Sie zeigt von Regionen hohen Drucks hin
