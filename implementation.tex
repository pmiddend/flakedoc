...
\PimiddyInlineCode{GL\_POINTS} an. Programm lst:implementation_point_sprite_vertex_shader zeigt den dazugehörigen Vertexshader. Im Vertexshader kann man nun der
Variable \PimiddyInlineCode{gl\_PointSize} einen
\PimiddyInlineCode{float}-Wert zuweisen, um die Größe des Punktes zu
setzen. Der Fragmentshader enthält den zweidimensionalen Vektor
\PimiddyInlineCode{gl\_FragCoords} $\in [0,1]^2$. Dieser Vektor gibt an,
